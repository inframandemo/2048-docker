![Docker Image Size (tag)](https://img.shields.io/docker/image-size/agrawpri/2048-docker/latest) main ha ha ffff

Hosted on GitHub Pages: https://agrawpri.github.io/2048-docker/    fh

This is a dockerized version of the 2048 game cloned from https://github.com/gabrielecirulli/2048.         vcv
...
4. `docker run --rm -p 80:80 2048`fdfdfd
